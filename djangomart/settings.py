...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'orangestorewebsiteemail@gmail.com'
EMAIL_HOST_PASSWORD = "haaditdeeoeuzvlv"
EMAIL_USE_TLS = True

SSLCOMMERZ_PAYMENT_URL = 'https://sandbox.sslcommerz.com/gwprocess/v3/api.php'
  # Update with production URL for live environment
SSLCOMMERZ_STORE_ID = 'orang64f811d753627'
SSLCOMMERZ_STORE_PASSWORD = 'orang64f811d753627@ssl'
